...
- This semester (Fall 2023), the course will follow closely along the previous Fall versions of this course. In particular, the projects will use the Go programming language.
- This semester (Fall 2023), lectures are going to be on Tuesdays and Thursdays from 11:00AM-12:20PM in CUC McConomy Auditorium. 
...
<!-- This year (Fall 2023) exceptionally, we have decided to allow these students to join the course _after_ the waitlist clears for students who have the proper prerequisites (if it clears). -->
